...
<<<<<<< HEAD
                  ...
                  className="w-full bg-transparent border-b border-[#3D1A1F] outline-none py-1.5 text-[#3D1A1F] font-oswald"
                />
              </div>
...
<<<<<<< HEAD
                  ...
                  onChange={handleChange}
                  className="w-full bg-transparent border-b border-[#3D1A1F] outline-none py-1.5 text-[#3D1A1F] font-oswald resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                className="bg-[#FFE066] text-[#3D1A1F] font-oswald font-bold text-base px-6 py-2.5 rounded-full border-b-2 border-[#3D1A1F] shadow-md active:translate-y-1 w-full"
=======
                  required
