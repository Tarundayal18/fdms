...
export default function Navbar() {
  ...
  useEffect(() => {
    if (isOpen) setAnimationKey(prev => prev + 1)
  }, [isOpen, showServices])
  ...
  return (
    <>
      <style jsx>{`
        ...
        @keyframes slideUp {
          from { opacity: 0; transform: translateY(60px) rotate(-8deg) scale(0.85); }
        ...
        .animate-slide-up { animation: slideUp 0.6s cubic-bezier(0.34,1.56,0.64,1) backwards; }
        .animate-scale-in { animation: scaleIn 0.5s cubic-bezier(0.34,1.56,0.64,1) backwards; }
        .rotate-slight-left { transform: rotate(-2deg); }
        .rotate-slight-right { transform: rotate(2deg); }
        .rotate-tiny-right { transform: rotate(1deg); }
        .rotate-tiny-left { transform: rotate(-1deg); }
      `}</style>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                    {navLinks.slice(0, 2).map((item, idx) => (
                      <div
                        ...
                        className={`bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 rounded-full py-6 px-10 text-center font-oswald text-2xl sm:text-3xl italic text-gray-900 shadow-lg animate-slide-up cursor-pointer ${
                          idx === 0 ? "rotate-slight-left" : "rotate-tiny-right"
                        }`}
                    ...
                    <button
                      onClick={() => setShowServices(true)}
                      className="bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 rounded-full py-6 px-10 text-center font-oswald text-2xl sm:text-3xl italic text-gray-900 shadow-lg animate-slide-up rotate-tiny-left hover:scale-105 hover:rotate-2 flex items-center justify-center gap-2"
                      style={{ animationDelay: "0.25s" }}
                    >
                      services
                      <ChevronDown size={24} />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                    {navLinks.slice(2).map((item, idx) => (
                      <div
                        ...
                        onClick={() => handleNavigate(item.href)}
                        className={`bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 rounded-full py-6 px-10 text-center font-oswald text-2xl sm:text-3xl italic text-gray-900 shadow-lg animate-slide-up cursor-pointer ${
                          idx === 0 ? "rotate-slight-right" : "rotate-slight-left"
                        }`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                    {navLinks.slice(0, 2).map((item, idx) => (
                      <div
                        key={item.href}
                        onClick={() => handleNavigate(item.href)}
                        className={`bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 rounded-full py-6 px-10 text-center font-oswald text-2xl sm:text-3xl italic text-gray-900 shadow-lg animate-scale-in cursor-pointer ${
                          idx === 0 ? "rotate-slight-left" : "rotate-tiny-right"
                        }`}
                    ...
                    <button
                      onClick={() => setShowServices(false)}
                      className="bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 rounded-full py-6 px-10 text-center font-oswald text-2xl sm:text-3xl italic text-gray-900 shadow-lg animate-scale-in rotate-tiny-left flex items-center justify-center gap-2"
                      style={{ animationDelay: "0.15s" }}
                    >
                      services
                      <ChevronUp size={24} />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    {services.map((service, index) => (
                      <div
                        ...
                        className={`bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 rounded-full py-5 px-8 text-center font-oswald text-xl sm:text-2xl italic text-gray-900 shadow-lg animate-scale-in cursor-pointer ${
                          index % 2 === 0 ? "rotate-tiny-right" : "rotate-tiny-left"
                        }`}
                        style={{ animationDelay: `${0.2 + index * 0.1}s` }}
                      >
                        {service.label}
